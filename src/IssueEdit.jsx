...
class IssueEdit extends React.Component {
  ...
  render() {
    ...
    // The id is set to something like null when:
    // 1. the state does not contain such value. OR
    // 2. the state contains an invalid id, like undefined, null, or etc.
    if (id == null) {
      // The propsId will not be set to null when:
      // an id is passed from the path.
      if (propsId != null) {
